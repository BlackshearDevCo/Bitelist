...
export const buttonVariantOptions = Object.keys(variantConfig.variant) as Array<
  keyof (typeof variantConfig)["variant"]
>;
export const buttonSizeOptions = Object.keys(variantConfig.size) as Array<
  keyof (typeof variantConfig)["size"]
>;
